...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002232612097')) #Log channel id ( make sure bot is admin )
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002296972913')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002232612097')) # add premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002296972913') #Channel / Group Id for force sub ( make sure bot is admin )
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002232612097')) #Log channel id ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', '420a77a0afc4888005507087ec2fd65b4399953a')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/GMoviesXA')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/UmeshGurjar1390')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('GMOVIESX_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/GMoviesXA')
